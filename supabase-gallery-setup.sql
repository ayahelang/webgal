-- Silverhawk Gallery Alumni DB
-- Jalankan di Supabase SQL Editor (boleh project baru atau yang sama dengan CBT)

create extension if not exists "pgcrypto";

-- Pengaturan (kode akses input alumni)
...
-- GANTI kode ini setelah setup
insert into gallery_settings(key, value) values
  ('submit_code', 'SilverhawkAlumni2026')
on conflict (key) do nothing;

-- Angkatan (unik, tidak boleh dobel)
create table if not exists gallery_angkatan (
  id uuid primary key default gen_random_uuid(),
  label text not null,
  label_norm text not null unique,
  source text default 'manual', -- migration | manual | alumni
...
create table if not exists gallery_alumni (
  ...
  legacy_id text, -- id dari JSON lama (51-1 dll)
  school text default 'SMA PMA',
  role text default 'Alumni / Santriwati',
  created_at timestamptz default now(),
...
-- Chat: angkatan_id null = lintas angkatan (global)
...
-- RLS: baca publik, tulis terbatas via anon + validasi di app (kode akses dicek client + optional RPC)
...
-- Policies longgar untuk demo GitHub Pages (anon key). Perketat di production jika perlu.
...
-- Realtime untuk chat
-- Di dashboard Supabase: Database → Replication → tambahkan gallery_chat

insert into gallery_angkatan(label, label_norm, source) values ('Kelas 51', 'kelas-51', 'migration') on conflict (label_norm) do nothing;
insert into gallery_angkatan(label, label_norm, source) values ('Kelas 52', 'kelas-52', 'migration') on conflict (label_norm) do nothing;

-- Seed alumni + websites dari websites.json

insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Anindya Yahya', 'anindya-yahya', a.id, '51-1', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
where al.name_norm = 'anindya-yahya' and a.label_norm = 'kelas-51'
  and not exists (
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Bintang Pertiwi', 'bintang-pertiwi', a.id, '51-2', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'bintang-pertiwi' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Bunga Fella', 'bunga-fella', a.id, '51-3', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'bunga-fella' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Hafiza Khaira', 'hafiza-khaira', a.id, '51-4', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'hafiza-khaira' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Haniffah Amallia', 'haniffah-amallia', a.id, '51-5', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'haniffah-amallia' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Kartika Chandra', 'kartika-chandra', a.id, '51-6', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'kartika-chandra' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Khansa Aura', 'khansa-aura', a.id, '51-7', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'khansa-aura' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Lathifah Khairunnisa', 'lathifah-khairunnisa', a.id, '51-8', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'lathifah-khairunnisa' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Lubna Anindya', 'lubna-anindya', a.id, '51-9', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'lubna-anindya' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Nadya Wafa', 'nadya-wafa', a.id, '51-10', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'nadya-wafa' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Naysilla Nadine', 'naysilla-nadine', a.id, '51-11', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'naysilla-nadine' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Putri Donita', 'putri-donita', a.id, '51-12', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'putri-donita' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Rezkya Putri Novianti', 'rezkya-putri-novianti', a.id, '51-13', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'rezkya-putri-novianti' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Rily Avfianca', 'rily-avfianca', a.id, '51-14', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'rily-avfianca' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Salsabila Kirana', 'salsabila-kirana', a.id, '51-15', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'salsabila-kirana' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Samsa Baina Sabiha', 'samsa-baina-sabiha', a.id, '51-16', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'samsa-baina-sabiha' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Shafiyyah Az-zahra', 'shafiyyah-az-zahra', a.id, '51-17', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'shafiyyah-az-zahra' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Tania Amanda', 'tania-amanda', a.id, '51-18', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'tania-amanda' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Widiya Sari', 'widiya-sari', a.id, '51-19', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'widiya-sari' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Ziya Ulhaq', 'ziya-ulhaq', a.id, '51-20', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-51'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'ziya-ulhaq' and a.label_norm = 'kelas-51'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Adinda Dwi Muliasari', 'adinda-dwi-muliasari', a.id, '52-21', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'adinda-dwi-muliasari' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Aneira Syiami Zulfa', 'aneira-syiami-zulfa', a.id, '52-22', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'aneira-syiami-zulfa' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Carissa Chikal Maghfirah', 'carissa-chikal-maghfirah', a.id, '52-23', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'carissa-chikal-maghfirah' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Chelsea Conera', 'chelsea-conera', a.id, '52-24', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'chelsea-conera' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Dina Aulia Khairunisa', 'dina-aulia-khairunisa', a.id, '52-25', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'dina-aulia-khairunisa' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Firzaa Halwa Izzatii', 'firzaa-halwa-izzatii', a.id, '52-26', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'firzaa-halwa-izzatii' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Fitriani Ramadhani', 'fitriani-ramadhani', a.id, '52-27', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'fitriani-ramadhani' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Hafinzah Islami Madinah', 'hafinzah-islami-madinah', a.id, '52-28', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'hafinzah-islami-madinah' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Khansa Nida Nafisah', 'khansa-nida-nafisah', a.id, '52-29', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'khansa-nida-nafisah' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Khanza Hazirah', 'khanza-hazirah', a.id, '52-30', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'khanza-hazirah' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Najla Sa''adah', 'najla-sa-adah', a.id, '52-31', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'najla-sa-adah' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Nazwa Febrian Maulida', 'nazwa-febrian-maulida', a.id, '52-32', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'nazwa-febrian-maulida' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Rezkya Ananda Putri', 'rezkya-ananda-putri', a.id, '52-33', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'rezkya-ananda-putri' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Rindu Putri Yasmin', 'rindu-putri-yasmin', a.id, '52-34', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'rindu-putri-yasmin' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Risma Jian Humaira', 'risma-jian-humaira', a.id, '52-35', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'risma-jian-humaira' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Syifa Azka', 'syifa-azka', a.id, '52-36', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'syifa-azka' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Thania Aulia Salsabila', 'thania-aulia-salsabila', a.id, '52-37', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'thania-aulia-salsabila' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Viorine Allinesia', 'viorine-allinesia', a.id, '52-38', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'viorine-allinesia' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Wifa Jelita Putri', 'wifa-jelita-putri', a.id, '52-39', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'wifa-jelita-putri' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Yasmin Indira Dewi', 'yasmin-indira-dewi', a.id, '52-40', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'yasmin-indira-dewi' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
...
insert into gallery_alumni(name, name_norm, angkatan_id, legacy_id, school, role)
select 'Nikeisha Belva Azzahra', 'nikeisha-belva-azzahra', a.id, '52-41', 'SMA PMA', 'Santriwati'
from gallery_angkatan a where a.label_norm = 'kelas-52'
on conflict (name_norm, angkatan_id) do update set legacy_id = excluded.legacy_id;
...
from gallery_alumni al
join gallery_angkatan a on a.id = al.angkatan_id
where al.name_norm = 'nikeisha-belva-azzahra' and a.label_norm = 'kelas-52'
  and not exists (
    select 1 from gallery_websites w2
